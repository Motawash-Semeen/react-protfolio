...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_r7myu3i', 'template_r2phz77', form.current, 'i_w_iLieF4cj2hGiH')
        e.target.reset()
    }; 
  return (
    <>
        ...
        Get in touch</h2>
                ...
                <div className="contact__container sontainer grid">
                    <div className="cantact__content">
